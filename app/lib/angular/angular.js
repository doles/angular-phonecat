...
function Browser(window, document, $log, $sniffer) {
  ...
  self.url = function(url, replace) {
    ...
    if (url) {
      ...
      if(typeof location.href === 'undefined'){
        console.log("location.href undefined");
        
      }
      if (lastBrowserUrl == url) {
        console.log("self.url does nothing, lastBrowserUrl = "+lastBrowserUrl);
        return;
      }
      var expectedUrlFailed = false;
      //lastBrowserUrl = url;
      if ($sniffer.history) {
        if (replace) {
          console.log("before history.replaceState, url: "+url+ ", location.href: "+location.href);
          try {
          ...
          console.log("after history.replaceState, url: "+url+ ", location.href: "+location.href);
        }
        else {


          console.log("before history.pushState, url: "+url+ ", location.href: "+location.href);
          try {
          ...
          console.log("after history.pushState, url: "+url+ ", location.href: "+location.href);
        ...
        if(location.href == url) {
          ...
          console.log("in self.url, $sniffer.history expectedUrlFailed");
          expectedUrlFailed = true;
        }
      }
      if (!$sniffer.history || expectedUrlFailed) {
          console.log(">>>>>>>>>>>>>>>>>>");

        if (replace) {
          console.log("before location.replace, url: "+url+ ", location.href: "+location.href);
          try {
          ...
          console.log("after location.replace, url: "+url+ ", location.href: "+location.href);
        }
        else {
          console.log("before location.href, url: "+url+ ", location.href: "+location.href);
          try {
            location.assign(url);
          }
          catch (exception){
          ...
          console.log("after location.href, url: "+url+ ", location.href: "+location.href);
        }
      }
      lastBrowserUrl = url;
      return self;
    // getter
      ...
      return (location.href || lastBrowserUrl).replace(/%27/g,"'");
    }
  };
  ...
  function fireUrlChange() {
    ...
    console.log("in fireUrlChange(), $browser.url(): "+self.url()+ ",location.href: "+location.href+", callbacks: "+ urlChangeListeners.length);
    //alert("in fireUrlChange(), $browser.url(): "+self.url()+ ",location.href: "+location.href+", callbacks: "+ urlChangeListeners.length);
    ...
    forEach(urlChangeListeners, function(listener, k) {
      console.log("in fireUrlChange fireing listener "+k+" for $browser.url(): "+self.url());
      //alert("in fireUrlChange(), $browser.url(): "+self.url()+ ",location.href: "+location.href+", callbacks: "+ urlChangeListeners.length);
      listener(self.url());
    });
  }
  ...
  self.onUrlChange = function(callback) {
    ...
    console.log("in $browser.onUrlChange(), $browser.url(): "+self.url()+ ", callback: ");
...
function $LocationProvider(){
  ...
  this.$get = ['$rootScope', '$browser', '$sniffer', '$rootElement',
    ...
    $browser.onUrlChange(function(newUrl) {
      ...
      console.log("executing onUrlChange, newUrl: "+newUrl+ ", $location.absUrl(): "+$location.absUrl() );
      ...
      if ($location.absUrl() != newUrl) {
        $rootScope.$evalAsync(function() {
          ...
          console.log("doing afterLocationChange in callback, newUrl: "+newUrl+ ", $location.absUrl(): "+$location.absUrl() );
    ...
    $rootScope.$watch(function $locationWatch() {
      ...
      console.log("in $locationWatch(), $browser.url(): "+oldUrl+ ", location.href: "+location.href);

      if (!changeCounter || oldUrl != $location.absUrl()) {
        changeCounter++;
        $rootScope.$evalAsync(function() {

          console.log("in $locationWatch() $rootScope.$evalAsync(), $location.absUrl(): "+$location.absUrl()+", oldUrl: "+oldUrl+", next opeation: ");

          if ($rootScope.$broadcast('$locationChangeStart', $location.absUrl(), oldUrl).
              defaultPrevented) {

            console.log("in $location.$$parse(oldUrl)");
            $location.$$parse(oldUrl);        

          } else {

            console.log("$browser.url($location.absUrl(), $location.$$replace);");
...
var ngViewDirective = ['$http', '$templateCache', '$route', '$anchorScroll', '$compile',
  ...
  return {
    ...
    link: function(scope, element, attr) {
      ...
      scope.$on('$routeChangeSuccess', function(){update(true);});
      update();
      ...
      function update(fromEvent) {
        ...
        console.log("in ngViewDirective update(), $browser.url(): "+$browser.url() + " from event: "+fromEvent);
        ...
        if (template) {
          ...
          console.log("in ngViewDirective scope.$new(), $browser.url(): "+$browser.url());
